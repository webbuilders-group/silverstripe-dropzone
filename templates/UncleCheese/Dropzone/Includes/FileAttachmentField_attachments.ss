    ...
    <span class="dropzone-actions">
        ...
        <% if $Scope.CanDelete %>
            <span data-delete class="dropzone-action delete">
                ...
                <img src="$resourceURL('webbuilders-group/silverstripe-dropzone: images/trash.png')" width="16">
            </span>
        <% end_if %>
    </span>
    ...
    <% if $Scope.CanDetach %>
        <span class="overlay detach-overlay">
            <span>
                ...
                <span data-delete-revert class="revert"><img src="$resourceURL('webbuilders-group/silverstripe-dropzone: images/undo.png')" width="16"></span>
            </span>
        </span>
    <% end_if %>
    <% if $Scope.CanDelete %>
